...
!function (a, b) {
    ...
    n.parseJSON = function (b) {
        ...
        try {
            a.DOMParser ? (d = new a.DOMParser, c = d.parseFromString(b, "test/xml")) : (c = new a.ActiveXObject("Microsoft.XMLDOM"), c.async = "false", c.loadXML(b))
        } catch (e) {
            c = void 0
        }
    ...
    n.ajaxSetup({
        accepts: {script: "test/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
