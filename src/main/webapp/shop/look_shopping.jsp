   ...
   <div style="width: 900px;margin: 0 auto;height: 75px;line-height: 75px">
      ...
      <div style="float: left;padding-left: 140px;padding-top:-5px;">
        ...
        <div style="float: left;padding-left: 105px;padding-top: 17px" class="shopcar">
            <a href="<c:url value='../shopcarServlet/selectshopcar?cid=0'/>">
...
<div class="container">
        ...
        <table class="table table-striped table-hover table-condensed" style="width: 1100px;float: left;border-bottom: 1px solid silver">
            <tr>
...
<!--  <div >
    <div style="margin-left: 330px">
        <button class="hover-red"  style="float: left;padding-left: 0px;width: 56px;height: 26px;border:1px solid silver;border-right: 0px;" id="def">综合⬇</button>
        <button class="hover-red"  style="float: left;padding-left: 0px; width: 56px;height: 26px;border:1px solid silver;border-right: 0px;" id="inv">销量⬇</button>
        <button class="hover-red"  style="float: left;padding-left: 0px;width: 56px;height: 26px;border: 1px solid silver;border-right: 0px;" id="up">价格⬆</button>
        <button class="hover-red" style="float: left;padding-left: 0px;width: 56px;height: 26px;border: 1px solid silver;"id="down">价格⬇</button>
    </div>
    <div style="margin-left: 565px;margin-top: -30px;">
        <input type="text" id="price1" style="width: 51px;height: 26px" placeholder="￥">
        </div>
    <div style="margin-left: 620px;margin-top: -30px;">
       -
    </div>
    <div style="margin-left: 630px;margin-top: -33px;">
        <input type="text" id="price2" style="width: 51px;height: 26px" placeholder="￥">
    </div>

    </div>-->
    
    <div style="height: 25px;">
    <button class="hover-red"  style="margin-left: 371px;width: 56px;height: 26px;border:1px solid silver;border-right: 0px;"id="def">综合⬇</button>
    <button class="hover-red"  style="margin-left: -4px;width: 56px;height: 26px;border:1px solid silver;border-right: 0px; "id="inv">销量⬇</button>
    <button class="hover-red"  style="margin-left: -4px;width: 56px;height: 26px;border:1px solid silver;border-right: 0px; "id="up">价格⬆</button>
    <button class="hover-red"  style="margin-left: -4px;width: 56px;height: 26px;border:1px solid silver;"id="down">价格⬇</button>
    
    </div>

<div id="hide1" style=" position: absolute;margin-top: -30px; margin-left: 607px;width: 125px;height: 70px;border: 1px solid silver;display: none" >

</div>
    <div id="showdiv" style="width: 115px;height: 60px;position:  relative;margin-top: -25px; margin-left: 612px;">
        <input id="price1" type="text" style="width: 51px;height: 26px;border: 1px solid silver;" placeholder="￥"><span> - </span>
    <input id="price2" type="text" style="width: 51px;height: 26px;border: 1px solid silver;" placeholder="￥">

        <input id="hide2" type="button" value="确定" style="width: 51px;height: 26px;border: 1px solid silver;margin-left: 63px;margin-top: 6px;display: none" placeholder="￥">

    </div>

<div class="row" >
    <div class="col-md-3" style="border-right: 1px solid silver; margin-top: -35px;">
        <div style="padding-left: 40px;padding-top: 20px;font-weight: 900;">
            <p style="padding-left: 70px;float:top;margin-top:-50px;font-weight: 900;font-size: large;">药品精选</p>
            <p></p>
            </div>
        <div  id="banner" style="width: 300px;height:240px;margin: 0 auto;position: relative">
            <div class="picture" >
            
                <a href="<c:url value="../shopcarServlet/selectOne?cid=7"/>">
                    <img src="<c:url value='/images/shopping/yao-7.png'/>" class="pg-picture" id="yao-1-1">
                </a>
                <a href="<c:url value="../shopcarServlet/selectOne?cid=9"/>" style="display: none">
                    <img src="<c:url value='/images/shopping/yao-9.png'/>" class="pg-picture">
                </a>
                <a href="<c:url value="../shopcarServlet/selectOne?cid=11"/>" style="display: none">
                    <img src="<c:url value='/images/shopping/yao-11.png'/>" class="pg-picture">
                </a>
                <a href="<c:url value="../shopcarServlet/selectOne?cid=12"/>" style="display: none">
...
//        hover进入时停止定时器，进入时设置定时器
          ...
          "success": function(data){
                 ...
                 for(var i = 0 ; i < data.length ; i++){
                      ...
                      var  $div = $("<div class='pg-content-img' >"+
                               ...
                               " <span><a href='<c:url value='../shopcarServlet/selectshopcar?cid=\"+obj.cid+\"'/>' ><button id='addcar'></button></a></span>"+
                               "<p><a href='<c:url value='../shopcarServlet/selectOne?cid=\"+obj.cid+\"'/>' class='hover-red'>"+obj.synopsis+"</a></p></div>");
                      n++;    
                      if(n>3){n=0;};     
    ...
    $("#def").click(function(){
    	window.location.href = "<c:url value='/shop/look_shopping.jsp'/>";
        })
 ...
 $("#hide2").click(function () {
    ...
    $.get({
      ...
      "data": "method=selectPriceto&price1=" + $price1+"&price2=" + $price2,
      "dataType":"json",
      "success": function(data){
