...
<div style="float:left; margin-left: 195px;margin-top: 30px; width: 900px;height: 220px;border: 1px solid silver">
    ...
    <p style="margin-left:60px;">
        校区：
        <select id="pre" onchange="chg(this);" style="width: 120px;margin-left:25px;">
            <option id="school" >--请选择校区---</option>
        </select>
        楼区：
        <select id="city" onchange="chg2(this);" style="width: 120px;">
            <option>--请选择楼区---</option>
        </select>
        寝室：
    ...
    <p style="margin-left:60px;font-weight: 700">配送地址：<span id="adds" style="font-weight: 500"><span id="address1"></span><span id="address2"></span><span id="address3"></span></span></p>
...
<div style="float:left; margin-left: 195px;margin-top: 30px;width: 900px;height: 280px;border: 1px solid silver">
    ...
    <p class="order"><span style="color: red" id="num-1">2 </span>件商品，总商品金额：<span class="order2"><span>￥</span ><span id="count1"></span></span></p>
    ...
    <p class="order">应付金额：<span style="float: right; margin-right: 0px;font-weight: 900;font-size: x-large;color: red"><span>￥</span><span id="counts"></span></span></p>
    <p class="order1"><button id="orderto" style="width: 135px;height: 35px;font-weight: 900;font-size: large;background: red;color:white;border: hidden">提交订单</button></p>
</div>
...
$("#inventory").text(getCookie("ck7"));
    ...
    $("#address").click(function () {
        ...
        var l=$("#city").val();
        var q=$("#area").val();
        $("#address1").text(pres[s])
        $("#address2").text(cities[s][l]);
        $("#address3").text(area[s][l][q]);
        var name=$("#name1").val();
        $("#name-get").text(name);
        var phone=$("#phone").val();
