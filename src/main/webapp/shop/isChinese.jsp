...
<div class="container">
        ...
        <table class="table table-striped table-hover table-condensed" style="width: 1100px;float: left;padding-left: -30px;border-bottom: 1px solid silver">
            <tr>
						...
						function() {
							$.get({
								 "url":"<c:url value='/ShopcarServlet'/>",
										"data" : "method=selectClass&productname=中药",
										"dataType" : "json",
