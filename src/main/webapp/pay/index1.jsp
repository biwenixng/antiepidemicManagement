...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=<c:url value='../pay/alipay.trade.page.pay.jsp'/> method=post
			target="_blank">
...
<script src="<c:url value="/images/shopping/jquery-3.4.1.min.js"/>"></script>
<script>
	...
	/*function GetDateNow() {
		...
		document.getElementById("WIDtotal_amount").value = "0.91";
	}
	GetDateNow();*/
